...
const SYSTEM_FIELDS = [
  ...
  { value: 'domain', label: '🏢 תחום ראשי', keywords: ['תחום', 'domain', 'category', 'main'] },
  { value: 'sub_domain', label: '📂 תת-תחום', keywords: ['תת', 'sub', 'תחום משני', 'secondary'] },
  { value: 'sub_sub_domain', label: '📁 תת-תת-תחום', keywords: ['רמה 3', 'level 3', 'tertiary'] },
