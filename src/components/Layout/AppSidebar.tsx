...
export function AppSidebar() {
  ...
  return <Sidebar className="border-l border-gold/30 bg-teal-800">
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              {menuItems.map(item => <SidebarMenuItem key={item.title}>
                  <SidebarMenuButton asChild isActive={location.pathname === item.url} className="text-base py-3 px-4 rounded-lg hover:bg-primary/10 transition-colors">
